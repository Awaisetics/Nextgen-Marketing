            ...
            <div className="w-60 max-w-full px-4 xl:mr-12">
                  ...
                  >
                    <span className="text-xl font-bold whitespace-nowrap ">
                      <span className="text-blue-400">NextGen</span> 
              ...
              <div>
                ...
                >
                  ...
                  <div className="flex items-center justify-end pr-16 lg:pr-0">
                    <Link
                      href="#contact"
                      className="hidden rounded-md bg-primary px-7 py-3 text-base font-medium text-white duration-300 hover:bg-primary/80 md:block dark:bg-primary dark:hover:bg-primary/80"
                    >
                      Contact
                    </Link>
                <div>
